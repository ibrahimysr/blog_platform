        ...
        <div class="glass-effect rounded-3xl shadow-2xl overflow-hidden border border-white/20">
            ...
            <div class="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 px-8 py-10 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h1 class="text-3xl font-black text-white mb-2 tracking-tight">Hoş Geldiniz!</h1>
                    <p class="text-white/90 font-medium">Hesabınıza giriş yapın</p>
                </div>
            </div>
            ...
            <div class="px-8 py-8">
                ...
                <form method="POST" action="{{ route('login.post') }}" class="space-y-6">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="btn-primary w-full text-white px-6 py-4 rounded-xl font-bold text-base tracking-wide shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center space-x-2">
                        <span>GİRİŞ YAP</span>
