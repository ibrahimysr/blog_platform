        ...
        <nav class="container mx-auto px-4 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-10">
                    ...
                    <a href="{{ route('posts.list') }}" class="nav-link text-gray-700 hover:text-purple-600 font-semibold text-sm tracking-wide">YAZILAR</a>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    @else
                        <div class="relative dropdown group">
                            <button class="flex items-center space-x-3 text-gray-700 hover:text-purple-600 transition-all">
                            ...
                            <div class="dropdown-menu hidden group-hover:block absolute right-0 mt-4 w-56 glass-effect rounded-2xl shadow-2xl py-2 border border-white/20 overflow-hidden">
                                ...
                                <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-5 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 transition-all">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-6 mobile-menu-slide">
                <div class="flex flex-col space-y-2 mt-4">
                    ...
                    <a href="{{ route('posts.list') }}" class="text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 py-3 px-4 rounded-lg font-semibold text-sm transition-all">Yazılar</a>
