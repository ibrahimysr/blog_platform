	...
	<div class="flex min-h-screen">
		...
		<aside class="w-64 bg-white shadow-sm">
			...
			<nav class="mt-6">
				...
				<a href="{{ route('admin.hero-sliders.index') }}" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-50 hover:text-gray-900 border-l-4 {{ request()->routeIs('admin.hero-sliders.*') ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-transparent' }}">
					<svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
					</svg>
					Hero Slider
