...
@section('content')
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Yeni Etkinlik</h1>
                <p class="mt-1 text-sm text-gray-500">Yeni bir etkinlik ekleyin</p>
            </div>
        </div>
        ...
        <form id="event-form" method="POST" action="{{ route('admin.events.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="description" 
                          ...
                          placeholder="Etkinlik açıklamasını girin">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
