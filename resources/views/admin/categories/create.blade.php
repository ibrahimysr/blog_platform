...
@section('content')
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Yeni Kategori</h1>
                <p class="mt-1 text-sm text-gray-500">Yeni bir blog kategorisi ekleyin</p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form id="category-form" method="POST" action="{{ route('admin.categories.store') }}" class="space-y-6">
            @csrf
            <div>
